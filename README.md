...
面向中国数学建模/科研写作场景的一套 **Skills + MCP 绘图服务**。

这个仓库整理自本地 `D:\Documents\paper` 工程，主要服务于中文数学建模论文、竞赛论文、科研图件和可复用绘图能力建设。相比单纯模板，它更强调：

- 论文结构、摘要、模型、结果解释的完整写作链路
- 面向 CUMCM/高教社杯风格的严谨推导与证据闭环
- TikZ / MATLAB / Visio / Draw.io 多后端绘图 MCP
- 中文标注、美观排版、可编辑矢量图和复现实验
- 面向中国用户的本地化工作流

> 名字里的“华研杯”不是某个官方赛事名，而是“中文科研/数模写作与绘图工具箱”的辨识名。
